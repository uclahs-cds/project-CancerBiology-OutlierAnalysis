...
#Mean
cpcg.zscore.bygene.symbol <- read.delim("~/Documents/1.Project/1.CPCGENE_RNA-seq/Rawdata/cpcg.zscore.bygene.symbol.txt", row.names = 1);
#Median
...
cpcg.score <- cbind(cpcg.zscore.bygene.symbol$Mean, cpcg.zscore.bymedian$Median, cpcg.zscore.bytrimmean$Trimmean);
