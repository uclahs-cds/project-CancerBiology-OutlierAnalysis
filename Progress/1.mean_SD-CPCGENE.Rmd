...
#};
# cpcg.zscore.bygene.symbol <- cbind(cpcg.zscore.bygene, data.frame(cpcg.fpkm$Symbol), 
#                                    cpcg.fpkm.onlygene.mean, 
#                                    cpcg.fpkm.onlygene.sd);
#colnames(cpcg.zscore.bygene.symbol) <- c(colnames(cpcg.fpkm), "Mean", "sd");
# write.table(cpcg.zscore.bygene.symbol, 
#             file = 'cpcg.zscore.bygene.symbol.txt', 
#             sep = "\t", 
#             col.names = TRUE, 
#             row.names = TRUE, 
#             quote = FALSE)
...
cpcg.zrange.decrease <- cpcg.zscore.bygene.symbol.zrange[order(cpcg.zscore.bygene.symbol.zrange$z.range, 
                                                               decreasing = TRUE),];
