...
ccle.sample.outlier.status.overlap.na <- ccle.sample.outlier.status.overlap[rownames(cas.effect.breast.05.na),];
...
gene.effect.diff.matrix.05.overlap.match_rnai <- gene.effect.diff.matrix.05.overlap[rownames(gene.rnai.diff.matrix.05.overlap.na),];
gene.effect.diff.matrix.05.overlap.match_rnai.na <- na.omit(gene.effect.diff.matrix.05.overlap.match_rnai);
gene.rnai.diff.matrix.05.overlap.match_cas <- gene.rnai.diff.matrix.05.overlap[rownames(gene.effect.diff.matrix.05.overlap.match_rnai.na),];

# Create a data frame with RNAi and Cas-CRISPR differences and gene symbols
cor.diff.cas.rnai.effect <- data.frame(cbind(
    rnai = gene.rnai.diff.matrix.05.overlap.match_cas$diff,
    cas = gene.effect.diff.matrix.05.overlap.match_rnai.na$diff,
    symbol = gene.effect.diff.matrix.05.overlap.match_rnai.na$symbol
    ));
