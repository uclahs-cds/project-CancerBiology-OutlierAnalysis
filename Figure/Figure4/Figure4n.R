...
rnai.status.i <- sample.outlier.05.overlap.na.rnai[sub("\\..*","", rownames(sample.outlier.05.overlap.na.rnai)) %in% i,];
effect.score.i <- gene.effect.breast.t.num.match.05.na[sub("\\..*","", rownames(gene.effect.breast.t.num.match.05.na)) %in% i,];
effect.status.i <- sample.outlier.05.overlap.na[sub("\\..*","", rownames(sample.outlier.05.overlap.na)) %in% i,];
